...
public class LocalGuideFragment extends Fragment implements View.OnClickListener {
    ...
    private void queryDetails(String table) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Log.e("resource", item.getName() + ":" + item.getResourceId());
                item.setType(table);
    ...
    public void onClick(View view) {
        if(view == eats) {
            ...
            drinks.setBackgroundColor(Color.parseColor("#000000"));
            ...
            attr.setBackgroundColor(Color.parseColor("#000000"));
